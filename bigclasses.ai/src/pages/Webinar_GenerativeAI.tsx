...
import GenerativeAIRegistrationForm from 'src/pages/Webinar_registration_form_generativeai';
          ...
          <div className="relative mt-8 md:mt-0">
            <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-10 transform rotate-3 hover:rotate-0 transition-all duration-500 border-4 border-blue-100">
              <div className="bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl p-8 mb-6 flex flex-col items-center">
                ...
                <p className="text-center text-gray-600">Join 300+ aspiring AI Engineers</p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <CheckCircle className="text-green-600" size={20} />
                  <span className="text-gray-700">Real-time Q&A with AI experts</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="text-blue-600" size={20} />
                  <span className="text-gray-700">Hands-on GenAI project demo</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="text-blue-600" size={20} />
      ...
      <section className="py-12 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-xl sm:text-4xl font-bold text-gray-900 mb-4">Why Attend This Generative AI Webinar?</h2>
            <p className="text-base sm:text-xl text-gray-700 max-w-3xl mx-auto">
              Learn to Build Code, Audio & Video Generating AI Tools, Master ChatGPT, OpenAI, Prompting & Real-World Use Cases
              </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 sm:p-8 rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-blue-100">
              ...
              <p className="text-gray-600">Kickstart your journey in Generative AI with core concepts, tools, and real-world demos.</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 sm:p-8 rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-blue-100">
              <div className="bg-blue-600 rounded-full p-4 w-16 h-16 flex items-center justify-center mb-6">
              ...
              <p className="text-gray-600">Advance your expertise with cutting-edge models, prompt engineering, and custom AI solutions.</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 sm:p-8 rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-blue-100">
              <div className="bg-blue-600 rounded-full p-4 w-16 h-16 flex items-center justify-center mb-6">
              ...
              <p className="text-gray-600">Follow a clear roadmap to break into high-demand Generative AI roles—no prior experience needed.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="space-y-6">
              {[
                'Introduction to Generative AI, LLMs & Foundation Models',
                'Prompt Engineering with ChatGPT & Custom Use Cases',
                'Creating AI-Generated Content: Code, Audio & Video',
                'Exploring OpenAI, Sora, Midjourney & Other Tools'
              ].map((item, index) => (
            ...
            <div className="space-y-6">
              {[
                ...
                'Resume & Interview Tips for AI & ML Roles',
                'Career Roadmap: How to Enter the Generative AI Field',
                'Live Q&A with BigClasses AI Experts'
              ].map((item, index) => (
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl p-6 sm:p-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <CheckCircle className="text-green-600" size={20} />
                  <span className="text-gray-700">8+ Years of AI & Machine Learning Experience</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="text-green-600" size={20} />
                  <span className="text-gray-700">Delivered 50+ Sessions on Generative AI & LLMs</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="text-green-600" size={20} />
                  <span className="text-gray-700">Expert in OpenAI, AI Tools & Agent Building</span>
                </div>
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl mt-6">
                  <p className="text-gray-700 italic text-lg">
                    "I’ll help you master Generative AI by breaking down advanced concepts into simple, hands-on learning."
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Learn from AI Industry Experts</h3>
            </div>
            <div className="text-center">
              <div className="bg-black bg-opacity-10 rounded-full p-6 w-24 h-24 flex items-center justify-center mx-auto mb-4">
                <BookOpen size={40} className="text-black" />
              </div>
              <h3 className="text-xl font-bold mb-2">Hands-on GenAI Learning</h3>
            </div>
            <div className="text-center">
              <div className="bg-black bg-opacity-10 rounded-full p-6 w-24 h-24 flex items-center justify-center mx-auto mb-4">
                <TrendingUp size={40} className="text-black" />
              </div>
              <h3 className="text-xl font-bold mb-2">Career-Oriented AI Sessions</h3>
            </div>
            <div className="text-center">
              <div className="bg-black bg-opacity-10 rounded-full p-6 w-24 h-24 flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-12 sm:py-20 bg-gradient-to-br from-blue-50 to-blue-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-4">Generative AI Webinar – FAQs</h2>
            <p className="text-base sm:text-lg text-gray-700 max-w-2xl mx-auto">
              Got questions about the Generative AI webinar? Check our FAQs below or email us at <a href="mailto:info@bigclasses.com" className="text-purple-600 underline">info@bigclasses.com</a>
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
            <div>
              ...
              <FaqAccordion faqs={[
                {
                  question: "Who should attend this Generative AI webinar?",
                  answer: "Anyone curious about building AI tools that generate text, images, code, or media—perfect for students, tech professionals, and career switchers."
                },
                {
                  question: "Is the webinar really free?",
                  answer: "Yes! This 2-day live webinar is absolutely free, with no hidden charges."
                },
                {
                  question: "Will I get a certificate?",
                  answer: "Yes, all attendees will receive a certificate of participation after completing the webinar."
                }
              ]} />
            </div>
            <div>
              ...
              <FaqAccordion faqs={[
                {
                  ...
                  answer: "You’ll learn about Generative AI, Large Language Models, Prompt Engineering, OpenAI tools, and how to build real-world AI agents."
                },
                {
                  question: "Will there be a Q&A session?",
                  answer: "Absolutely! We’ll have a live Q&A where you can interact directly with industry experts."
                },
                {
                  question: "How do I join the webinar?",
                  answer: "Once you register, you’ll receive a confirmation email with the Zoom/Google Meet link and session details."
                }
              ]} />
            </div>
          </div>
...
export default GenerativeAIWebinar;
