...
7. **NO REPETITION**: Each topic name must be unique and different - NO topic should be repeated
8. **ACTUAL COURSE DATA**: Use ONLY the exact topics from the course data provided, not generic examples
9. **UNIQUE TOPICS**: If you only have 2 topics from the data, show only those 2 unique topics - do not repeat them to make more topics
10. **VERIFICATION**: Before responding, verify that each topic name is different from all others

CRITICAL: This is a topics request - show ALL modules/topics in the curriculum. Don't abbreviate or truncate the list. Each topic must be unique and from actual course data.`;
      }
...
4. **NO REPETITION**: Each topic name must be unique and different - NO topic should be repeated
5. **ACTUAL COURSE DATA**: Use ONLY the exact topics from the course data provided, not generic examples
6. **PRICING HANDLING**: For pricing queries, respond: "For detailed pricing information and flexible payment options, our advisors at +91 9666523199 will help you find the perfect plan for your budget."
7. **NO SALARY/HIKE DATA**: Remove all salary, career transition, or hike statistics
8. **ENGAGEMENT**: Ask which specific aspect excites them most
9. **PROFESSIONAL STRUCTURE**: Use clear headings and organized information
10. **VERIFICATION**: Before responding, verify that each topic name is different from all others

CRITICAL: Use ONLY the real course data provided. Show ALL available modules/topics with detailed descriptions. Each topic must be unique and from actual course data.`;
    }
...
3. **NO REPETITION**: Each topic name must be unique and different - NO topic should be repeated
4. **ACTUAL COURSE DATA**: Use ONLY the exact topics from the course data provided
5. **MAINTAIN ENTHUSIASM**: Keep the energy high and positive
6. **NO SALARY DATA**: Remove any salary/hike related information
7. **ADVISOR CONTACT**: End with warm invitation to contact advisors

CRITICAL: Use the course data provided to give comprehensive information while maintaining conversational flow. Each topic must be unique and from actual course data.`;
    }
...
3. **UNIQUE TOPICS RULE**: When listing course topics/modules, each topic name MUST be unique and different. NO topic name should be repeated within the same course. Use ONLY the actual topic names from the course data provided.

4. **FUZZY MATCHING**: When users misspell course names, use fuzzy matching to find similar courses and suggest corrections.
...
5. **COMPOUND QUERIES**: When users ask about a course AND want topics/duration/pricing:
   ...
   - Each topic name must be unique and different - NO topic should be repeated
   - Use ONLY actual topic names from the course data provided
...
1. **[Unique Module 1]**: [Description]
2. **[Unique Module 2]**: [Description]
3. **[Unique Module 3]**: [Description]
[Include ALL modules from course data, no abbreviation, each with unique names]

IMPORTANT: Each topic name must be unique and different. NO topic name should be repeated. Use ONLY the actual topic names from the course data provided.
...
- Ensure each topic/module name is unique and different within each course
- NO topic name should be repeated in the same course curriculum
- Use ONLY actual course topic names from the provided data, not generic examples
